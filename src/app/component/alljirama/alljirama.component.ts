...
@Component({
  selector: 'app-alljirama',
  templateUrl: './alljirama.component.html',
  styleUrls: ['./alljirama.component.scss']
})
export class AlljiramaComponent implements OnInit {
  historiquesArray = [];
  historiquesArray1 = [];
  compte:any;
  com:any;
        ...
        for (let index = 0; index < this.historiquesArraylist.length  ; index++) {
          ...
          var datetransaction = res2[0];
                      ...
                      if(this.historiquesArraylist[index].facture.expeditaire=='agentexterne'){
                        tab2[i][0] = "Reception du virement de l\'agent externe";
                        tab2[i][4] = "411002";
                      }
                      if(this.historiquesArraylist[index].facture.expeditaire=='agentsipem'){
                        tab2[i][0] = "Reception du virement de l\'agent Sipem";
                        tab2[i][4] = "512000";
                      }
                      if(this.historiquesArraylist[index].facture.expeditaire=='particulier'){
                        tab2[i][0] = "Reception du virement du client";
                        tab2[i][4] = "411001";
                      }
                      tab2[i][1]="CAIS";
