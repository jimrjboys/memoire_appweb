...
@Component({
  selector: 'app-societefintek',
  templateUrl: './societefintek.component.html',
  styleUrls: ['./societefintek.component.scss']
})
export class SocietefintekComponent implements OnInit {
    ...
    this.emplacementService.getHistoriques().subscribe(
      list => {
        ...
        for (let index = 0; index < this.historiquesArraylist.length   ; index++) {
          if(this.historiquesArraylist[index].facture.expeditaire!=''){
          if(this.historiquesArraylist[index].facture.recipient==us){
            this.compte++;
          ...
          if(this.historiquesArraylist[index].facture.expeditaire=='agentsipem'){
            tab2[i][0] = "Virement Commission par un Agent Sipem pour Fintek";
        }
        if(this.historiquesArraylist[index].facture.expeditaire=='particulier'){
            tab2[i][0] = "Virement Commission par un client direct pour Fintek";
           }
        if(this.historiquesArraylist[index].facture.expeditaire=='agentexterne'){
            tab2[i][0] = "Virement Commission par un agent externe pour Fintek";
        }
          tab2[i][1]="BQ1";
          tab2[i][2] = datetransaction;
          tab2[i][3] = y+"BQ"+this.bq;
          tab2[i][4] = "512100";
          tab2[i][5] = "";
          ...
          tab2[i][11] = this.comfin;
          tab2[i][12] = 0;  
        tab2[i][13]=res;         
        tab2[i+1]=new Array(14);
        if(this.historiquesArraylist[index].facture.expeditaire=='agentsipem'){
          tab2[i+1][0] = "Virement Commission par un Agent Sipem pour Fintek";
          tab2[i+1][9] = "SIPEM";
          tab2[i+1][5] = "411100";
      }
      if(this.historiquesArraylist[index].facture.expeditaire=='particulier'){
          tab2[i+1][0] = "Virement Commission par un client direct pour Fintek";
          tab2[i+1][9] = "Client";
          tab2[i+1][5] = "411300";                     }
      if(this.historiquesArraylist[index].facture.expeditaire=='agentexterne'){
          tab2[i+1][0] = "Virement Commission par un agent externe pour Fintek";
          tab2[i+1][5] = "411200";
          tab2[i+1][9] = "Agent externe";
        }
        tab2[i+1][1]="BQ1";
        tab2[i+1][2] = datetransaction;
        tab2[i+1][3] = y+"BQ"+this.bq;
        tab2[i+1][4] = "";
        ...
        tab2[i+1][11] =0;
        tab2[i+1][12] = this.comfin;
        tab2[i+1][13]=res;
        tab2[i+2]=new Array(14);
        tab2[i+2][0] = "Constatation de la commission en tant que produit";
        tab2[i+2][1]="VTE";
        ...
        tab2[i+2][11] = 0;
        tab2[i+2][12] = (this.comfin*100)/120;
        tab2[i+2][13]=res;
        tab2[i+3]=new Array(14);
        tab2[i+3][0] = "Constatation de la commission en tant que produit";
        tab2[i+3][1]="VTE";
        ...
        tab2[i+3][11] = 0;
        tab2[i+3][12] = (this.comfin*20)/120;
        tab2[i+3][13]=res;
      ...
      if(this.historiquesArraylist[index].facture.expeditaire=='agentexterne'){
          tab2[i+4][4] = "411200";
          tab2[i+4][9] = "Agent externe";
        }
         tab2[i+4][0] = "Constatation de la commission en tant que produit";
        tab2[i+4][1]="VTE";
        tab2[i+4][2] = datetransaction;
        tab2[i+4][3] = y+"Ve"+this.bq;
        tab2[i+4][5] = "";
        ...
        tab2[i+4][10]=this.historiquesArraylist[index].facture.invoiceRef + ' commission ' + res;
        tab2[i+4][11] =this.comfin;
        tab2[i+4][12] = 0;
        tab2[i+4][13]=res;              
         i=i+5;
                     this.bq++;
